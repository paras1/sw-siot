...
public class TopicUtil {
    ...
    public static String PREFIX_MNF = "SPA/TEST/AndroidSW/MNF";
    public static String PREFIX_CNF = "SPA/TEST/AndroidSW/CNF";
    public static String PREFIX_DAT = "SPA/TEST/AndroidSW/DAT";
