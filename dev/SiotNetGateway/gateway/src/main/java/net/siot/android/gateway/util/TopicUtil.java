...
public class TopicUtil {
    private static final String TAG = "siotag/TopicUtil";
    ...
    private static String PREFIX_MNF = "MNF/";
    private static String PREFIX_CON = "CON/";
    private static String PREFIX_DAT = "DAT/";
