...
\def \titleborder {Bachelor Thesis im Studiengang Informatik an der Berner Fachhochschule}
\def \version		{X1.0}
...
%---------------------------------------------------------------------------
\onecolumn
\include{02_Grundlagen/01_Grundlagen}
% Main part - Part III
%---------------------------------------------------------------------------
\onecolumn
\include{03_Analyse_Marktsegment_SW_IoT/01_Marktsegmente}
% Main part - Part IV
%---------------------------------------------------------------------------
\onecolumn
\include{04_Analyse_Anwendungen_SW_IoT/01_Anwendungen}
% Main part - Part V
%---------------------------------------------------------------------------
\onecolumn
\include{05_Technische_Anforderungen/01_Technische_Anforderung_an_SW}
% Main part - Part VI
%---------------------------------------------------------------------------
\onecolumn
\include{06_Evaluation_SW_Produkte/01_Evaluation_SW_Produkte}
% Main part - Part VII
%---------------------------------------------------------------------------
\onecolumn
\include{07_Architektur/01_Architektur}
% Main part - Part VIII
%---------------------------------------------------------------------------
\onecolumn
\include{08_Requirements/01_Anforderungsdokumente}
% Main part - Part IX
%---------------------------------------------------------------------------
\onecolumn
\include{09_Konzept/01_Konzept}
% Main part - Part X
%---------------------------------------------------------------------------
\onecolumn
\include{10_Implementation/01_Implementation}
% Main part - Part XI
%---------------------------------------------------------------------------
\include{11_Ergebnis/01_Ergebnis}
% Main part - Part XII
%---------------------------------------------------------------------------
\onecolumn
\include{12_Schlusswort/01_Schlusswort}
% Appendix
%---------------------------------------------------------------------------
...
\bibliography{99_Anhang/98_bibliography}{}
%---------------------------------------------------------------------------

\cleardoublepage
\renewcommand\listfigurename{Abbildungsverzeichnis}
\addcontentsline{toc}{chapter}{\texorpdfstring{\listfigurename}{Abbildungsverzeichnis}}
\listoffigures
\renewcommand\listtablename{Tabellenverzeichnis}
\addcontentsline{toc}{chapter}{\texorpdfstring{\listtablename}{Tabellenverzeichnis}}
\listoftables
\appendix
\settocdepth{section}
\onecolumn
\include{99_Anhang/01_Entwicklerhandbuch}
\onecolumn
\include{99_Anhang/02_Zeitplan}
%---------------------------------------------------------------------------
