...
%---------------------------------------------------------------------------
\onecolumn
\include{02_Analyse_Marktsegment_SW_IoT/01_Marktsegmente}

% Main part - Part III
%---------------------------------------------------------------------------
\onecolumn
\include{03_Analyse_Anwendungen_SW_IoT/01_Anwendungen}


% Main part - Part IV
%---------------------------------------------------------------------------
\onecolumn
\include{04_Technische_Anforderungen/01_Technische_Anforderung_an_SW}


% Main part - Part 5V
%---------------------------------------------------------------------------
\onecolumn
\include{05_Evaluation_SW_Produkte/01_Evaluation_SW_Produkte}
